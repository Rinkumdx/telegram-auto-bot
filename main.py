...
async def send_scheduled_content(chat_id: int, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        caption_10m = (
            ...
            "Our team analyzes the market 24/7 to give you exact entry points, targets, and stop-loss.\n"
            "Don't miss today's market profit! Join our channel now."
        )
        ...
        await context.bot.send_photo(
            chat_id=chat_id,
            photo="https://t.me/starcentre2/8?single",
            caption=caption_1h,
            parse_mode="Markdown"
        )
